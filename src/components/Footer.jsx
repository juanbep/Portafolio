  ...
  return (
    <footer className="bg-transparent text-white">
      <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center sm:items-start text-center sm:text-left py-9">
        <div className="flex-1 flex flex-col items-center sm:items-start mb-6 sm:mb-0">
        ...
        <div className="flex-1 flex flex-col items-center mb-6 sm:mb-0">
        ...
        <div className="flex-1 flex flex-col items-center sm:items-end">
          <span className="font-semibold">3D model's credits:</span>
          <br />
          <a
